		      ...
		      <div class="box-content-center product"><!-- The box-content-center -->
							...
							<ul id="thumblist" >
							    <li>
                                    <a class="zoomThumbActive" href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: '<?php echo base_url('upload/product/'.$product->image_link);?>',largeimage: '<?php echo base_url('upload/product/'.$product->image_link);?>'}">
                                        <img style="height: 50px;width: 50px;" src='<?php echo base_url('upload/product/'.$product->image_link);?> '>
                                    </a>
							    </li>
                                <?php if(is_array($image_list)):?>
                                    <?php foreach ($image_list as $img):?>
                                        <li>
                                            <a  href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: '<?php echo base_url('upload/product/'.$img);?>',largeimage: '<?php echo base_url('upload/product/'.$product->image_link);?>'}">
                                                <img style="height: 50px;width: 50px;" src='<?php echo base_url('upload/product/'.$img);?> '>
                                            </a>
                                        </li>
                                    <?php endforeach;?>
                                <?php endif;?>
		           ...
		           <div class='product_view_content'>
                       ...
                       <?php if($product->discount>0):?>
                           <?php $price_new=$product->price-(($product->discount*$product->price)/100);?>
                           <p class='option'>
                               Giá: <span class='product_price'> <?php echo number_format($price_new,0);?> đ</span>
                           </p>
                       <?php else:?>
                           <p class='option'>
                               Giá: <span class='product_price'> <?php echo number_format($product->price,0);?> đ</span>
                           </p>
                       <?php endif;?>
...
<div class="usual-content">
    ...
    <div id="tab4" style="display: none;">
        <div class='box-show-product'>
            ...
            <div class="comments">
                <div class="title"><h3>THẢO LUẬN CỦA KHÁCH HÀNG <span class="yellow">(0)</span></h3><h4>Ý kiến khách hàng về Sản phẩm Tivi LG 520</h4>
                </div>
                <br class="break">
                <div class="reviews">
                    <div class="content">
