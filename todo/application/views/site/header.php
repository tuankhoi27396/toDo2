...
<div id="menu"><!-- the menu -->
    <ul class="menu_top">
        ...
        <?php if(isset($user_info)):?>
            <li class=""><a href="<?php echo base_url('user'); ?>">Xin chào <?php echo $user_info->name;?></a></li>
            <li class=""><a style="color: red" href="<?php echo base_url('user/logout'); ?>">Đăng xuất</a></li>
        <?php else:?>
