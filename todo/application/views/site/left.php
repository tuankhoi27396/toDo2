                ...
                <div class="form-item" style="width:90px">
                    <select class="input" id="price_from" name="price_from">
                        <?php for($i=0;$i<=50000000;$i+=1000000):?>
                            <option <?php echo($price_from_select==$i)? 'selected': ''?> value="<?php echo $i; ?>"><?php echo $i; ?>đ</option>
                        <?php endfor;?>
                    </select>
                    <div class="clear"></div>
            ...
            <div class="form-row">
                ...
                <div class="form-item" style="width:90px">
                    <select class="input" id="price_to" name="price_to">
                        <?php for($i=0;$i<=50000000;$i+=1000000):?>
                            <option <?php echo($price_to_select==$i)? 'selected': ''?> value="<?php echo $i; ?>"><?php echo $i; ?> đ</option>
                        <?php endfor;?>
                    </select>
                    <div class="clear"></div>
                    <div class="error" id="price_from_error"></div>
