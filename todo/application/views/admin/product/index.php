        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable" id="checkAll">
            ...
            <tr>
                <td colspan="6">
                    <div class="list_action itemActions">
                        <a href="" id="submit" class="button blueB" url="<?php echo admin_url('product/delete_all')?>">
            ...
            <tr class="row_<?php echo $row->id;?>">
                ...
                <td class="option textC">
                    ...
                    <a href="<?php echo admin_url()?>/product/edit/<?php echo $row->id;?>" title="Chỉnh sửa" class="tipS">
                        <img src="<?php echo public_url() ?>admin/images/icons/color/edit.png">
                    </a>

                    <a href="<?php echo admin_url()?>/product/delete/<?php echo $row->id;?>" title="Xóa" class="tipS verify_action">
