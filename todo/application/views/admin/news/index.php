        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable" id="checkAll">
            ...
            <tr>
                <td colspan="6">
                    <div class="list_action itemActions">
                        <a href="" id="submit" class="button blueB" url="<?php echo admin_url('news/delete_all')?>">
            ...
            <tr class="row_<?php echo $row->id;?>">
                ...
                <td class="option textC">
                    ...
                    <a href="product/view/9.html" target="_blank" class="tipS" title="Xem chi tiết bài viết">
                        <img src="<?php echo public_url() ?>admin/images/icons/color/view.png">
                    </a>
                    <a href="<?php echo admin_url()?>/news/edit/<?php echo $row->id;?>" title="Chỉnh sửa" class="tipS">
                        <img src="<?php echo public_url() ?>admin/images/icons/color/edit.png">
                    </a>

                    <a href="<?php echo admin_url()?>/news/delete/<?php echo $row->id;?>" title="Xóa" class="tipS verify_action">
