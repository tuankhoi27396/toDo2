        ...
        <fieldset>
            <div class="widget">
                ...
                <div class="tab_container">
                    <div id="tab1" class="tab_content pd0">
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><input name="name" id="param_name" value="<?php echo $slide->name;?>" _autocheck="true" type="text"></span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <div class="left">
                                    ...
                                    <img src="<?php echo base_url('upload/slide/'.$slide->image_link)?>" width="100px" height="70px">
                                </div>
                            </div>
                            <div class="clear"></div>
                        </div>
                ...
                <div class="formSubmit">
                    ...
                    <input type="reset" value="Hủy bỏ" class="basic" onclick="window.location='<?php echo admin_url('slide/index');?>'" >
                </div>
                <div class="clear"></div>
            </div>
        </fieldset>
